package com.cqt.common.config.nacos;
...
public class CommonNacosConfigListener {
    ...
    public void init() throws Exception {
        ...
        for (String dataId : dataIds) {
            ...
            String content = nacosConfigManager.getConfigService().getConfigAndSignListener(dataId, abstractNacosConfig.getGroup(), 10000,

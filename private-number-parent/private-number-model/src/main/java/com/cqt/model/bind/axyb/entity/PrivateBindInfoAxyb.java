package com.cqt.model.bind.axyb.entity;
...
@AllArgsConstructor
@NoArgsConstructor
@TableName("private_bind_info_axyb")
public class PrivateBindInfoAxyb extends BaseAuth implements Serializable {

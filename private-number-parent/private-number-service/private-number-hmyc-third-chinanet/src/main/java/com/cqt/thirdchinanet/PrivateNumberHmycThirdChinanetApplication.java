...
@MapperScan("com.cqt.thirdchinanet")
@EnableSpringUtil
@EnableAsync
public class PrivateNumberHmycThirdChinanetApplication {
    ...
    public static void main(String[] args) throws UnknownHostException {
        ...
        ConfigurableApplicationContext application = SpringApplication.run(PrivateNumberHmycThirdChinanetApplication.class, args);

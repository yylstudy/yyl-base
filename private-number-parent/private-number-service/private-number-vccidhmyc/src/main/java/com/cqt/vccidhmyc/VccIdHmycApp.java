...
/**
 * @author linshiqiang
 * date:  2023-03-27 13:47
 */
@Slf4j
@SpringCloudApplication
public class VccIdHmycApp {

    public static void main(String[] args) throws UnknownHostException {
        System.setProperty("JM.SNAPSHOT.PATH", "/home/logs");
        System.setProperty("csp.sentinel.log.dir", "/home/logs/sentinel");
        ConfigurableApplicationContext application = SpringApplication.run(VccIdHmycApp.class, args);

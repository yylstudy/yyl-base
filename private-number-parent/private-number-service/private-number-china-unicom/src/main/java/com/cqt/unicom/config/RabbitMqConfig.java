...
import com.cqt.unicom.rabbitmq.MqReceiver;
...
public class RabbitMqConfig {
     ...
     * 交换机
     */
    public static final String PRIVATE_PUSH_EXCHANGE = "unicom-push-fail-exchange";

    /**
     * 话单推送失败延时队列
     * private-push-fail-delay-queue-{vccid}
     */
    public static final String PRIVATE_PUSH_DELAY_QUEUE = "unicom-push-fail-delay-queue-%s";

 ...
 */
@Slf4j
@Component(TaobaoBindInfoQueryTestAxeConfig.DATA_ID)
@RequiredArgsConstructor
public class TaobaoBindInfoQueryTestAxeConfig extends AbstractNacosConfig {

    public static final Map<String, CallControlResponse> CACHE = new ConcurrentHashMap<>(16);

    public static final String DATA_ID = "ali-bind-info-query-test-axe.json";

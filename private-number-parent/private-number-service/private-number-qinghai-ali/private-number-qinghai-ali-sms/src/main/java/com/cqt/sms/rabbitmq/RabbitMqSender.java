...
public class RabbitMqSender {
    ...
    public void sendLazy(Object message, String queueName,Integer rePushTime) {
        ...
        if (queueName.contains("ali-sms-push-fail-delay-queue")) {
            pushExchange = RabbitMqConfig.ALI_SMS_PUSH_EXCHANGE;
        } else {
            pushExchange = RabbitMqConfig.ALI_SMS_INTERCEPT_EXCHANGE;
        }
        //发送消息时指定 header 延迟时间
        rabbitTemplate.convertAndSend(pushExchange, queueName, message,
                new MessagePostProcessor() {
                    ...
                    public Message postProcessMessage(Message message) throws AmqpException {
                        ...
                        message.getMessageProperties().setDelay(rePushTime * 5 * 1000);
                        return message;
                    }
                }, correlationData);
    }

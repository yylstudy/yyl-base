 ...
 * @version 1.0.0
 * @Description
 * @createTime 2022/1/13 15:03
 */
public abstract class MySpringCloudCircuitBreakerFilterFactory extends
        AbstractGatewayFilterFactory<MySpringCloudCircuitBreakerFilterFactory.Config> {
    ...
    public MySpringCloudCircuitBreakerFilterFactory(
    ...
    public GatewayFilter apply(Config config) {
        ...
        return new GatewayFilter() {
            ...
            public String toString() {
                return filterToStringCreator(MySpringCloudCircuitBreakerFilterFactory.this)
    ...
    private Mono<Void> getVoidMono(ServerHttpResponse serverHttpResponse, int errorCode, String errorMsg) {
        ...
        Result result = Result.fail(errorCode, errorMsg);
    ...
    public class CircuitBreakerStatusCodeException extends HttpStatusCodeException {
        ...
        private static final long serialVersionUID = -66816399581387976L;

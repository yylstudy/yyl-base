...
@Data
public class PushCallRingingDTO extends BaseAuthDTO {
    ...
    public PrivateStatusInfo buildStatusInfo(PushCallRingingDTO.RequestBody requestBody) {
        PrivateStatusInfo statusInfo = new PrivateStatusInfo();
        statusInfo.setEvent(CallEventEnum.ringing.name());
        ...
        statusInfo.setCurrentTime(requestBody.getRingTime());
        // TODO 未提供

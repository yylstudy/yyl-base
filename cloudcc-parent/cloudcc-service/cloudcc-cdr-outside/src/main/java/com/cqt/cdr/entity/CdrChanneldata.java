...
@Getter
@Setter
@TableName("clouccc_cdr_channeldata")
...
public class CdrChanneldata implements Serializable {
     ...
     * ivr轨迹
     */
    @JsonProperty("variable_ivrTracks")
    private String ivrTracks;

    /**
     * 队列标识，1进队列、0出队列、空没触发队列节点
     */
    @JsonProperty("variable_ccQueueHangup")
    private String ccQueueHangup;

    /**
     * 第一次进队列开始时间
     */
    @JsonProperty("runccTimes")
    private LocalDateTime runccTimes;

    /**
     * 排队次数
     */
    @JsonProperty("ccBusyNo")

...
@Data
public class ClientPreviewOutCallDTO extends ClientRequestBaseDTO implements Serializable {
    ...
    @NotEmpty(message = "[client_number]不能为空!")

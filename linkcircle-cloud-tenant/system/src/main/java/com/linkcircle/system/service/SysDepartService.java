...
public interface SysDepartService extends IService<SysDepart> {
     ...
     * 部门列表
     */
    List<SysDepartDTO> listAll(String corpId);
    /**
     * 获取部门树形结构
     */
    List<SysDepartTreeDTO> departTree(String corpId);
     ...
     * @return
     */
    Result<String> add(String corpId,SysDepartAddDTO sysDepartAddDto);
     ...
     * @return
     */
    void deleteDepartById(String corpId,Long id);
...
//    List<Long> selfAndChildrenIdList(Long departId);
     ...
     *
     */
    Map<Long, String> getDepartmentPathMap(String corpId);
}

...
public interface SysRoleService extends IService<SysRole> {
    ...
    Result<List<SysRoleDTO>> getCorpRole();

    SysRole getSysRoleByRoleCodeAndCorpId(String roleCode,String corpId);

    /**
     * 获取企业下的角色
     */
    List<SysRole> getByCorpId(String corpId);
    /**
     * 获取企业管理员角色集合
     */
    List<SysRole> getCorpAdminRole(List<String> corpIdList);
}

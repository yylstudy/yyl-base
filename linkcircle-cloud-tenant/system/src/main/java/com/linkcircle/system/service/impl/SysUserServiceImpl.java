...
//        }
        ...
        sysUserQueryReqDto.setCorpId(corpId);
    ...
    public Result<PageResult<SysUserDTO>> queryNotInRoleUserByRoleId(SysRoleUserQueryReqDTO dto) {
        ...
        dto.setCorpId(sysRole.getCorpId());
    ...
    public Result<String> add(SysUserAddDTO sysUserAddDto) {
        String corpId = SystemLoginUserInfoHolder.getCorpId();
        // 校验电话是否存在
        SysUser sysUser = getByPhone(sysUserAddDto.getPhone());
        if (sysUser != null) {
        ...
        // 部门是否存在
//        checkDepart(sysUserAddDto.getDepartId());
        ...
        corpUser.setUserId(addSysUser.getId());
    ...
    public Result<String> edit(SysUserUpdateDTO sysUserUpdateDto) {
        ...
        String corpId = SystemLoginUserInfoHolder.getCorpId();
        List<Long> dbRoleIds = sysUserRoleService.getRoleIdsByCorpIdAndUserId(corpId,updateSysUser.getId());
    ...
    @Override
    public SysUser getByPhoneOrEmail(String phoneOrEmail) {
        LambdaQueryWrapper<SysUser> wrapper = Wrappers.lambdaQuery();
        wrapper.eq(SysUser::getPhone,phoneOrEmail);
        wrapper.or().eq(SysUser::getEmail,phoneOrEmail);
